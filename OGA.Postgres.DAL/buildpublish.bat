...
dotnet nuget push -s http://192.168.1.161:8080/v3/index.json ".\Publish\OGA.Postgres.DAL.3.4.4.nupkg"
dotnet nuget push -s http://192.168.1.161:8080/v3/index.json ".\Publish\OGA.Postgres.DAL.3.4.4.snupkg"
